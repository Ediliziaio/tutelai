      ...
      >
        {done ? (
          <div className="text-center">
            ...
            <Link
              to="/login"
              className="inline-flex items-center justify-center gap-2 bg-primary text-white hover:bg-primary rounded-full px-5 py-2.5 font-semibold text-sm transition-all"
            >
              Vai al login
            </Link>
          </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full border border-slate-200 rounded-lg px-3 py-2.5 pr-10 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all"
                  />
