...
export default function AppBilling() {
  ...
  return (
    <div className="p-6 space-y-6 bg-[#FAFAF8] min-h-full">
      ...
      {/* Piano card */}
      <div className="bg-white border-2 border-[#eab913] rounded-xl p-6 space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-3 mb-2">
              <span className="bg-[#eab913] text-[#1a375b] px-3 py-1 rounded-full text-sm font-bold">
            ...
            <div className="text-3xl font-bold text-[#1a375b]">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button className="border border-[#C8C5BC] hover:bg-gray-50 text-[#1a375b] px-4 py-2 rounded-lg text-sm font-medium transition-colors">
              Gestisci add-on
            </button>
      ...
      {/* Add-on */}
      <div>
        <h2 className="font-semibold text-[#1a375b] mb-3">Add-on disponibili</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {sub.add_ons.map((addon) => (
            <div
              key={addon.id}
              className={`bg-white border rounded-xl p-5 space-y-3 ${addon.attivo ? 'border-[#eab913] border-2' : 'border-[#C8C5BC]'}`}
            >
              ...
              <div>
                <div className="font-semibold text-[#1a375b] text-sm">{addon.nome}</div>
      ...
      {/* Totale */}
      <div className="bg-[#FDF8E7] border border-[#eab913]/50 rounded-xl px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2 text-[#1a375b]">
        ...
        <div className="text-2xl font-bold text-[#1a375b]">
      ...
      <div className="bg-white border border-[#C8C5BC] rounded-xl overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-100">
          <h2 className="font-semibold text-[#1a375b]">Storico fatture</h2>
        </div>
            ...
            <tbody className="divide-y divide-gray-100">
              {sub.storico_fatture.map((f) => (
                <tr key={f.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-6 py-3 font-semibold text-[#1a375b]">€{f.importo}</td>
      ...
      <div className="bg-white border border-[#C8C5BC] rounded-xl p-6 space-y-3">
        <div className="flex items-center justify-between">
          <h2 className="font-semibold text-[#1a375b]">Dati di fatturazione</h2>
          <button className="border border-[#C8C5BC] hover:bg-gray-50 text-[#1a375b] px-3 py-1.5 rounded-lg text-xs font-medium flex items-center gap-1 transition-colors">
        ...
        <div className="text-sm text-gray-700 space-y-0.5">
          <div className="font-medium text-[#1a375b]">{tenant?.ragione_sociale}</div>
