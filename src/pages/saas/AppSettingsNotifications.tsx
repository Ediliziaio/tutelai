...
function Toggle({ checked, onChange }: { checked: boolean; onChange: () => void }) {
  return (
    <button
      ...
      onClick={onChange}
      className={`relative w-10 h-5 rounded-full transition-colors shrink-0 ${checked ? 'bg-[#1a375b]' : 'bg-gray-200'}`}
    >
      <span
...
export default function AppSettingsNotifications() {
  ...
  return (
    <div className="p-6 space-y-6 bg-[#FAFAF8] min-h-full">
      ...
      <div>
        <h1 className="text-2xl font-bold text-[#1a375b]">Impostazioni — Notifiche</h1>
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-[#1a375b]">Email</div>
          ...
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-[#1a375b] flex items-center gap-2">
                  WhatsApp
          ...
          <div className="flex items-center justify-between py-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-sm font-medium text-[#1a375b]">Slack</div>
                <div className="text-xs text-gray-500">Integra con il tuo workspace Slack</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              {channels.slack && (
                <button className="border border-[#C8C5BC] hover:bg-gray-50 text-[#1a375b] px-3 py-1.5 rounded-lg text-xs font-medium transition-colors">
                  Configura
                </button>
              )}
      ...
      {/* Tipi notifica */}
      <div className="bg-white border border-[#C8C5BC] rounded-xl p-6 space-y-4">
        <h2 className="font-semibold text-[#1a375b]">Tipi di notifica</h2>
          ...
          {notifTypes.map((n) => (
            <div key={n.id} className="flex items-center justify-between py-3">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-[#1a375b]">{n.label}</span>
              </div>
      ...
      {/* Digest email */}
      <div className="bg-white border border-[#C8C5BC] rounded-xl p-6 space-y-4">
        <h2 className="font-semibold text-[#1a375b]">Digest email settimanale</h2>
