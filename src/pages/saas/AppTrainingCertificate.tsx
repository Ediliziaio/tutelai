    ...
    return (
      <div className="min-h-screen bg-[#FAFAF8] flex items-center justify-center">
        <div className="text-center">
          <p className="text-xl font-bold text-[#1a375b] mb-2">Corso non trovato</p>
    ...
    <div className="min-h-screen bg-[#FAFAF8] py-10 px-6">
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-white border-2 border-[#C8C5BC] rounded-2xl overflow-hidden shadow-lg mb-6 print:shadow-none">
          {/* Top blue border */}
          <div className="h-3 bg-gradient-to-r from-[#1a375b] to-[#185FA5]" />
          ...
          <div className="p-10">
            ...
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <span className="text-2xl font-black text-[#1a375b] tracking-tight">TUTELAI</span>
                <span className="text-2xl font-light text-[#185FA5]">PLATFORM</span>
              </div>
              <div className="w-24 h-0.5 bg-[#C8C5BC] mx-auto mb-4" />
              <h2 className="text-xl font-bold text-[#1a375b] tracking-wide uppercase">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-3xl font-black text-[#1a375b] mb-2">{userName}</p>
              ...
              <div className="bg-[#E6F1FB] border border-[#185FA5]/20 rounded-xl p-5 mb-5">
                <h3 className="text-lg font-bold text-[#1a375b] mb-1">{corso.titolo}</h3>
            ...
            <div className="border-t border-[#C8C5BC] pt-6 flex items-center justify-between">
              ...
              <div className="text-left">
                <div className="w-16 h-16 border-2 border-[#1a375b] rounded-lg flex items-center justify-center mb-2">
                  <div className="grid grid-cols-4 gap-0.5">
                    {Array.from({ length: 16 }).map((_, i) => (
                      <div
                        key={i}
                        className={`w-2.5 h-2.5 rounded-sm ${Math.random() > 0.4 ? 'bg-[#1a375b]' : 'bg-transparent'}`}
                      />
                    ))}
                  </div>
                </div>
              ...
              <div className="text-center flex-1">
                ...
                <p className="text-sm font-mono font-bold text-[#1a375b] bg-[#F5F5F3] px-3 py-1.5 rounded-lg inline-block">
                  {codiceVerifica}
                </p>
              </div>
              ...
              <div className="text-right">
                <div className="flex items-center justify-end gap-1 mb-1">
                  ...
                  <span className="text-sm font-black text-[#1a375b]">TUTELAI</span>
                </div>
                <p className="text-xs text-gray-400">tutelai.it</p>
                <div className="w-20 h-0.5 bg-[#1a375b] mt-2 ml-auto" />
          ...
          {/* Bottom border */}
          <div className="h-1.5 bg-gradient-to-r from-[#185FA5] to-[#1a375b]" />
        </div>
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 border border-[#C8C5BC] text-[#1a375b] hover:bg-gray-50 rounded-lg text-sm font-medium transition-colors"
          >
